...
Удостоверились что данных нет, значит нужно прописывать. Теперь нужно найти нашу установленную open-java jdk. В Unix java устанавливается по умолчанию в директорию usr/lib/jvm/, удостоверимся, что она там
> $ cd /usr/lib/jvm/; ls
