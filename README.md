...
- sh скрипт для быстрой настройки vim __В разработке__
- sh скрипт для быстрой установки kotlin __В разработке__
- sh скрипт для быстрой настройки gradle __В разработке__
