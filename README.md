...
Как это использовать - напишу позже, в доп файле приложу sh скрипты для более быстрой насройки сервера
- [sh скрипт для быстрой настройки сервера](server-config.sh)
